...
public class KeepMembersAnnotatedByLibraryTest extends TestBase {
  ...
  public void testKeep() throws Exception {
    runTest(
        "-keep class * { @java.lang.Deprecated <methods>; }",
  ...
  public void testKeepClassMembers() throws Exception {
    runTest(
        "-keep class * -keepclassmembers class * { @java.lang.Deprecated <methods>; }",
        (testClass, otherClass) -> {
          assertThat(testClass, isPresent());
          assertThat(testClass.uniqueMethodWithOriginalName("test"), isPresent());
          assertThat(otherClass, isPresent());
  ...
  public void testKeepClassesWithMembers() throws Exception {
    runTest(
        "-keepclasseswithmembers class * { @java.lang.Deprecated <methods>; }",
        (testClass, otherClass) -> {
          assertThat(testClass, isPresent());
          assertThat(testClass.uniqueMethodWithOriginalName("test"), isPresent());

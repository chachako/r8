 ...
 */
package com.android.tools.r8.jdk9.twr.twrcloseresourceduplication.asm;
...
public class TwrCloseResourceDuplicationDump implements Opcodes {
  ...
  public static byte[] dump() throws Exception {
    ...
    classWriter.visit(
        ...
        "com/android/tools/r8/jdk9/twr/twrcloseresourceduplication/TwrCloseResourceDuplication",
        null,
        "java/lang/Object",
        null);
    ...
    classWriter.visitInnerClass(
        "com/android/tools/r8/jdk9/twr/twrcloseresourceduplication/TwrCloseResourceDuplication$Bar",
        "com/android/tools/r8/jdk9/twr/twrcloseresourceduplication/TwrCloseResourceDuplication",
        "Bar",
        ACC_PUBLIC | ACC_STATIC);

    classWriter.visitInnerClass(
        "com/android/tools/r8/jdk9/twr/twrcloseresourceduplication/TwrCloseResourceDuplication$Foo",
        "com/android/tools/r8/jdk9/twr/twrcloseresourceduplication/TwrCloseResourceDuplication",
        "Foo",
        ACC_PUBLIC | ACC_STATIC);

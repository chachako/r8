...
public class VarHandleDesugaringArrayOfLongTest extends varhandle.VarHandleDesugaringTestBase {
  ...
  private static final String MAIN_CLASS = ArrayOfLong.class.getTypeName();
  ...
  protected List<Class<?>> getProgramClasses() {
    return ImmutableList.of(ArrayOfLong.class);
  }

...
public class VarHandleDesugaringInstanceBooleanFieldTest
  ...
  private static final String MAIN_CLASS = InstanceBooleanField.class.getTypeName();
  ...
  protected List<Class<?>> getProgramClasses() {
    return ImmutableList.of(InstanceBooleanField.class);
  }

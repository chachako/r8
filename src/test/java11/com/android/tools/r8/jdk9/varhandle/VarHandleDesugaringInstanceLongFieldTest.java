...
public class VarHandleDesugaringInstanceLongFieldTest
  ...
  private static final String MAIN_CLASS = InstanceLongField.class.getTypeName();
  ...
  protected List<Class<?>> getProgramClasses() {
    return ImmutableList.of(InstanceLongField.class);
  }
